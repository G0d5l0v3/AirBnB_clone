...
class HBNBCommand(cmd.Cmd):
    ...
    def precmd(self, line):
        ...
        # User.update(id, {"first_name":"Udo_Kibii", "email":"test@alx.com"})
        ...
        # this find [, {"first_name":"Udo_kibii", "email":"test@alx.com"})]
        args = re.search(r",.+?\)", line)
        evl_dict = ''
        if args:
            # change [, {"first_name":"Udo_Kibii", "email":"test@alx.com"})]
            # to [{"first_name":"Udo_Kibii", "email":"test@alx.com"}]
        ...
        # User.update(id, {"first_name":"Udo_Kibii", "email":"test@alx.com"})
        # will become this
        # update User id {"first_name":"Udo_Kibii", "email":"test@alx.com"}
        return new_line
